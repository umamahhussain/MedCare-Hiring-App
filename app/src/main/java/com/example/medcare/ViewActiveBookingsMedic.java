...
public class ViewActiveBookingsMedic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_active_bookings_medic);

        recyclerView = findViewById(R.id.appointmentsRecyclerViewActive);
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot snap : snapshot.getChildren()) {
                            ...
                            if (appt != null && "confirmed".equals(appt.getStatus())) {
                    ...
                    public void onCancelled(DatabaseError error) {
                        Toast.makeText(ViewActiveBookingsMedic.this, "Error fetching appointments", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}
